---
layout: page
title: M2 Internship<br>n°2 | 2020
...
From July to November 2020, I worked at the Research Center on Animal Cognition (CRCA) in Toulouse, France, under the supervision of [Sylvie Guillerme](https://geode.univ-tlse2.fr/accueil/personnel/sylvie-guillerme) and [Martin Giurfa](https://en.wikipedia.org/wiki/Martin_Giurfa). Despite the constraints of the COVID‑19 pandemic, we were fortunate to conduct fieldwork in the Pyrenees, where we measured the spectral reflectance of flowers. We then used a perceptual approach based on the neural mechanisms of bee vision to compare different properties of local flowers with invasive flowers. Our results suggested two main strategies for invasive flowers: either resembling local species to blend into the floral community and encourage generalization by bees, or standing out visually to potentially attract more pollinators. In this work, we focused on visual cues, but invasive plants use multiple sensory dimensions, so this work is now followed by the thesis of [Frank Weber](https://theses.fr/s312048)
